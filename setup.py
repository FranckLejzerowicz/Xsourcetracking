...
with open("Xsourcetracking/__init__.py", "rb") as f:
    hit = _version_re.search(f.read().decode("utf-8")).group(1)
    version = str(ast.literal_eval(hit))

standalone = ['Xsourcetracking=Xsourcetracking.scripts._standalone_xsourcetracking:standalone_xsourcetracking']

setup(
    name="Xsourcetracking",
    version=version,
    license="BSD",
    ...
    url="https://github.com/FranckLejzerowicz/Xsourcetracking",
